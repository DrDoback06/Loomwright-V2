...
export function CommandPalette({ onClose }: { onClose: () => void }) {
  ...
  const commands: Command[] = useMemo(
    () => [
      ...
      { id: 'plan', title: 'Go to Plan', subtitle: 'Outline, Board, Matrix, Timeline', shortcut: 'Alt+2', run: () => go('plan') },
      { id: 'codex', title: 'Go to Codex', subtitle: 'Everything your story knows', shortcut: 'Alt+3', run: () => go('codex') },
      { id: 'insights', title: 'Go to Insights', subtitle: 'Overview, Today, Review', shortcut: 'Alt+4', run: () => go('insights') },
      { id: 'worlds', title: 'Go to Worlds', subtitle: 'Atlas, Tangle, Skill Trees', shortcut: 'Alt+5', run: () => go('worlds') },
