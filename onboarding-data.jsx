...
const ONBOARDING_STEPS = [
  { id: "welcome",     n: 1,  num: "01", title: "Welcome",                short: "Project setup",       lede: "Name your project, pick a format, and tell Loomwright what you’re carrying in.", optional: false, group: "begin",   payoff: "Sets your project’s identity and starts the Project Intelligence that keeps every AI suggestion on-brand." },
  { id: "foundation",  n: 2,  num: "02", title: "Story Foundation",       short: "Premise & shape",     lede: "The bones of the book — premise, conflict, themes, and what it isn’t.", optional: false, group: "shape",   payoff: "Your premise, themes and tone become the spine Loomwright checks every draft and edit against." },
  { id: "style",       n: 3,  num: "03", title: "Writing Style Profile",  short: "Style profile",       lede: "Calibrate the prose dials so AI helpers stay in your voice, not theirs.", optional: false, group: "shape",   payoff: "These dials are guardrails — AI drafts and rewrites stay in your voice instead of a generic one." },
  { id: "voice",       n: 4,  num: "04", title: "Voice Sample",            short: "Voice / sample",      lede: "Paste a passage you’re proud of. Loomwright will mirror its rhythm, not memorise it.", optional: true,  group: "shape",   payoff: "Lets Loomwright mirror your sentence rhythm and shapes — it studies the cadence, never copies the words." },
  { id: "world",       n: 5,  num: "05", title: "World & Canon",          short: "World rules",         lede: "Set the load-bearing facts. Mark the ones AI must never bend.", optional: true,  group: "world",   payoff: "Canon rules become facts AI can never contradict — and the factions & places you name become real entities." },
  { id: "cast",        n: 6,  num: "06", title: "Character Seeds",         short: "Cast",                lede: "Drop in starter cards. You can grow them as the book is written.", optional: true,  group: "world",   payoff: "Each seed becomes a Character in your Cast panel — linked to the factions, classes and races you set." },
  { id: "rpg",         n: 7,  num: "07", title: "RPG / Tracking Systems", short: "Tracking",            lede: "Decide what gets tracked: classes, stats, items, quests — or none of it.", optional: true,  group: "world",   payoff: "Custom stats become real Stat entities, and your choices tune what extraction watches for as you write." },
  { id: "plot",        n: 8,  num: "08", title: "Plot Roadmap",           short: "Roadmap",             lede: "Sketch the spine. Beats can be vague or surgical — both work.", optional: true,  group: "world",   payoff: "Beats sketch your arc and tell Loomwright which chapters to focus on when it extracts entities." },
  { id: "manuscript",  n: 9,  num: "09", title: "Manuscript Import",      short: "Manuscript",          lede: "Start blank or carry in chapters from elsewhere.", optional: true,  group: "library", payoff: "Bring chapters in now and Loomwright can auto-extract characters, places and factions from them." },
  { id: "references",  n: 10, num: "10", title: "References",              short: "References",          lede: "Lore docs, world bibles, prior books. Tell Loomwright how each should be used.", optional: true,  group: "library", payoff: "World bibles and notes you add feed AI context and canon — tagged by how each should be used." },
  { id: "ai",          n: 11, num: "11", title: "AI & Privacy",            short: "AI & privacy",        lede: "Choose what (if anything) leaves the device. Keys are stored locally.", optional: false, group: "trust",   payoff: "You decide what (if anything) leaves the device. Keys stay local and you can see every AI call." },
  { id: "review",      n: 12, num: "12", title: "Review Rules",            short: "Review rules",        lede: "How aggressive should extraction be, and what counts as a finding?", optional: false, group: "trust",   payoff: "Tunes how eagerly extraction finds entities, and what auto-adds vs waits in your review queue." },
  { id: "workspace",   n: 13, num: "13", title: "Workspace Preferences",   short: "Workspace",           lede: "How the desk should be laid out before you sit down.", optional: false, group: "trust",   payoff: "Lays out your desk — where you start, the type, the panels — so it’s ready the moment you sit down." },
  { id: "summary",     n: 14, num: "14", title: "Final Summary",           short: "Summary",             lede: "What Loomwright now knows. Last chance to adjust before the door opens.", optional: false, group: "finish",  payoff: "Finishing seeds your Cast, Factions, Locations, Classes & Races, chapters and canon — all ready to grow." },
];
