      ...
      <TweaksPanel title="Tweaks" defaultOpen={false}>
        ...
        <TweakSection title="Debug" subtitle="Live state — for verification only">
          <div style={{
            ...
            <div><b>Relationships:</b> {(window.LoomwrightBackend?.EntityService?.listSync("relationships") || []).length} rels · {(window.LoomwrightBackend?.ReviewService?.listSync("relationships") || []).length} review</div>
            <div><b>Timeline:</b> {((window.LoomwrightBackend?.EntityService?.listSync("timeline") || []).length + (window.LoomwrightBackend?.EntityService?.listSync("events") || []).length)} beats · {((window.LoomwrightBackend?.ReviewService?.listSync("timeline") || []).length + (window.LoomwrightBackend?.ReviewService?.listSync("events") || []).length)} review</div>
