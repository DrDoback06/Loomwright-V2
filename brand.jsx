...
const ENTITY_TYPES = {
  ...
  factions:    { id: "factions",    label: "Factions",      plural: "Factions",      color: "#3d3a78", soft: "#cfcde2", deep: "#1c1a3a", glyph: "▣", icon: "shield" },
...
const NAV_ITEMS = [
  ...
  { id: "factions",      label: "Factions",      icon: "shield",   group: "entities", kind: "panel", entity: "factions",      panelKind: "factions" },
